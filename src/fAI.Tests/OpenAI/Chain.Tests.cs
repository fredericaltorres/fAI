...
namespace fAI.Tests
{
    class FactDB  : IChainable
    {
        ...
        {
            // James Bond Facts
            {1000, "Creation by Ian Fleming: James Bond, code number 007, was created by British author Ian Fleming in 1952."},
            {1001, "First Appearance in 'Casino Royale': Bond debuted in Fleming's novel 'Casino Royale,' published in 1953."},
            {1002, "Iconic Code Number, 007: Bond's '00' prefix indicates a license to kill in the line of duty."},
            {1003, "Film Adaptations: The Bond film series began with 'Dr. No' in 1962."},
            {1004, "Signature Drink: 'Vesper Martini,' described in 'Casino Royale' as a mix of Gordon's, vodka, and Kina Lillet."},

            // Elvis Presley Facts
            {1005, "King of Rock and Roll: Elvis Presley is known as the 'King of Rock and Roll' and is one of the most significant cultural icons of the 20th century."},
            {1006, "First Hit Single: His first hit single, 'Heartbreak Hotel,' was released in 1956 and became a number-one hit in the U.S."},
            {1007, "Graceland: Elvis's home, Graceland, in Memphis, Tennessee, is one of the most visited private homes in America."},
            {1008, "Film Career: Presley starred in 33 successful films, further establishing his fame and influence."},
            {1009, "Best-Selling Solo Artist: Elvis is recognized by Guinness World Records as the best-selling solo music artist of all time."}
        };
