namespace fAI
{
    ...
    /// curl.exe https://api.openai.com/v1/audio/voice_consents -X POST -H "Authorization: Bearer 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" -F "name=test_consent" -F "language=en" -F "recording=@C:\DVT\fAI\src\fAI.Lib\OpenAI\Audio\VoiceSamples\Fred OpenAI Sample.wav;type=audio/x-wav"
    /// </summary>
