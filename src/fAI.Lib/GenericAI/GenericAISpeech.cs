...
namespace fAI
{
    public class GenericAISpeech : HttpBase, IGenericAISpeech
    {
        ...
        public List<TTSRequest> TTSVoiceInfos = new List<TTSRequest>
        {
            ...
            new TTSRequest { PricePerMillionOfChars=15,     Model = "fish-audio/s2.1-pro",              Voices = new List<string>() { "b347db033a6549378b48d00acb0d06cd", "9a9cf47702da476aa4629e2506d4a857" }, SupportVoiceCloning = true }, // https://docs.fish.audio/features/text-to-speech
