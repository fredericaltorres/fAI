...
namespace fAI
{
    public class GenericAISpeech : HttpBase, IGenericAISpeech
    {
        ...
        public class TTSRequest
        {
            ...
            public float PricePerMillion { get; set; }
            ...
            public float ComputeCost(int characteres)
            {
                ...
                return (totalTokens / 1000000f) * PricePerMillion;
            }
        }

        public List<TTSRequest>  TTSVoiceInfos = new List<TTSRequest>
        {
            new TTSRequest {  PricePerMillion=16, Model = "mistralai/voxtral-mini-tts-2603", Voices = new List<string>() {
