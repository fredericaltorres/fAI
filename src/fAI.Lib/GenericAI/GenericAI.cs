...
namespace fAI
{
    public class GenericAISpeech : HttpBase, IGenericAISpeech
    {
        ...
        {
            //new TTSRequest { PricePerMillionOfChars=15.15f /* estimated by chat gpt */,  Model = "gpt-4o-mini-tts", Voices = new List<string>() { "alloy","ash","ballad","coral","echo","fable","nova","onyx","sage","shimmer","verse" }, OpenRouterSupported = false },
