...
";
        ...
        const string BugJargal_Summary_Sanitized = @"As French literature expert and people expert.
Generate an image inspired by Victor Hugo's classic novel, 'Bug-Jargal'.
Also used the following book's summary as a prompt:
""Bug-Jargal"" is a historical novel by Victor Hugo set during the slave revolt in Santo Domingo in 1791. 
The protagonist, a French military officer named Leopold d'Auverney, recounts his experiences during the revolt. 
He befriends Bug-Jargal, a noble African slave who becomes a revolutionary leader. Despite their differences, they form a deep bond. 
...
The story ends tragically with Bug-Jargal's execution, symbolizing the high cost of freedom.
